...
export default function AdminPage() {
  ...
  const overallStats = useMemo(() => {
    ...
    totalAttempts = type1Attempts + type2Attempts + type3Attempts
    totalCorrect = type1Correct + type2Correct + type3Correct
  ...
  const getWordStats = (word: typeof words[0]) => {
    ...
    return { totalAttempts, totalCorrect, overallRate, type1Rate, type2Rate, type3Rate }
  }
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center border rounded p-4">
              <p className="text-sm text-muted-foreground mb-2">유형 1 (듣고 한글 뜻 쓰기)</p>
            ...
            <div className="text-center border rounded p-4">
              <p className="text-sm text-muted-foreground mb-2">유형 2 (단어→뜻)</p>
            ...
            <div className="text-center border rounded p-4">
              <p className="text-sm text-muted-foreground mb-2">유형 3 (뜻→단어)</p>
